...
> **Personal fork** — I'm using this to experiment with local LLM inference via Ollama. Main changes: lowered default temperature and max iterations for more deterministic/cheaper runs.
